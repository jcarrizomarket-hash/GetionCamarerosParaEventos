...
import { createMockFetchError } from '../mocks';
...
describe('updatePedido', () => {
  it('debe actualizar un pedido', async () => {
    mockFetchOnce({ success: true, data: mockPedidos.pedidoSimple });

    const result = await updatePedido('pedido-001', { cliente: 'Actualizado' });
  ...
  it('debe usar método PUT', async () => {
    ...
    await updatePedido('pedido-001', { cliente: 'Actualizado' });
  ...
  it('debe manejar error de red', async () => {
    ...
    const result = await updatePedido('pedido-001', { cliente: 'Test' });
...
describe('createCamarero', () => {
  it('debe crear un camarero', async () => {
    const nuevoCamarero = { numero: 10, nombre: 'Nuevo Camarero', activo: true };
  ...
  it('debe manejar error de red', async () => {
    ...
    const result = await createCamarero({ numero: 1, nombre: 'Test', activo: true });
...
describe('updateCamarero', () => {
  ...
  it('debe manejar error de red', async () => {
    ...
    const result = await updateCamarero('cam-001', { nombre: 'Test' });
