...
export function EnvioParte({ pedidos, camareros, coordinadores, clientes, baseUrl, publicAnonKey }) {
  ...
  // Deduplicar pedidos y ordenar ascendentemente (fecha más próxima arriba)
  ...
  const pedidoSeleccionado = uniquePedidos.find((p: any) => p.id === selectedPedido);
                ...
                <div className="flex gap-2 ml-4">
                  ...
                  <button
                    onClick={() => {
                      ...
                      const clienteData = clientes.find((c: any) => c.nombre === pedido.cliente);
                      const emailsCliente: any[] = [];
