    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden animate-in fade-in slide-in-from-top-4">
      ...
      <form onSubmit={handleSubmit} className="p-6">
        ...
        <div className="mt-8 pt-4 border-t border-gray-200 flex justify-end gap-3">
          ...
          <button type="submit" disabled={submitting} className="px-6 py-2 bg-blue-600 text-white rounded-lg font-medium shadow-sm disabled:opacity-50 disabled:cursor-not-allowed">{submitting ? 'Guardando...' : editingCamarero ? 'Guardar Cambios' : 'Crear Perfil'}</button>
        </div>
      </form>
    </div>
  );
